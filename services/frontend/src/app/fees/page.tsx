...
export default function FeesPage() {
  ...
  const getFeeValue = (protocol: ProtocolFee, timeFrame: TimeFrameType) => {
    switch (timeFrame) {
      case 'daily':
  ...
  const getRevenueValue = (protocol: ProtocolFee, timeFrame: TimeFrameType) => {
    switch (timeFrame) {
      case 'daily':
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-3/4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                ...
                <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg font-medium">Fee Trends</CardTitle>
                  </CardHeader>
                  <CardContent className="py-2">
                    <FeeTrendsChart data={generateTimeData(timeFrame)} />
                  </CardContent>
                </Card>
              </div>
            </div>
